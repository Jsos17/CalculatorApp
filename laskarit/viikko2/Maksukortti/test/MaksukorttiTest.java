...
public class MaksukorttiTest {
    ...
    public void setUp() {
     ...
     @Test
     public void negatiivistaSaldoEiVoiLadata() {
         kortti.lataaRahaa(-10.0);
         assertEquals("Kortilla on rahaa 10.0 euroa", kortti.toString());
     }
     
     @Test
     public void edullisenLounaanVoiOstaaTasmalleenRiittavallaSaldolla() {
     ...
     @Test
     public void maukkaanLounaanVoiOStaaTasmalleenRiittavallaSaldolla() {
